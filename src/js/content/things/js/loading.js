        ...
        <a.div className="th-loading-container-3" style={setWidth}  >
            <a.div className="th-loading-container-2" >
                ...
                <a.h2 style={fadeOut} className="th-loading-title">Loading...</a.h2>
                    ...
                    <a.div style={fadeIn} className="th-loading-container">

                        <div className="hiroshima">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 373 95.91">
                                <a.path className="st0 svht" stroke="#a9c0ed" style={{ strokeDashoffset: prop.intersecting === "th-loading" ? b.interpolate(b => `${b}`) : null }}
                        ...
                        <img style={{ width: "100%" }} src="https://live.staticflickr.com/65535/50504100842_6b29acd783_o.jpg"></img>
                    </a.div> 
